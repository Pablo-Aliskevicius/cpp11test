...
#include "Performance.h"
 ...
 // Short functions are more visible to objdump. 
    ...
    long long Performance::UnfairTest(vector<test> &tests) 
    {
        ...
        sw.Stop();
        cout << "Side effect for UnfairTest(): " << result << endl;
    ...
    long long Performance::InlinedStandardLoop(const vector<test> &tests) 
    {
        ...
        sw.Stop();
        cout << "Side effect for InlinedStandardLoop(): " << result << endl;
        return sw.GetElapsedNanoseconds().count();
    }
    long long Performance::InlinedRecursion(vector<test> &tests) 
    {
        ...
        sw.Stop();
        cout << "Side effect for InlinedRecursion(): " << result << endl;
        return sw.GetElapsedNanoseconds().count();
    }
    ...
    long long Performance::InlinedMatrix(vector<test> &tests) 
    {
        ...
        sw.Stop();
        cout << "Side effect for InlinedMatrix(): " << result << endl;
        return sw.GetElapsedNanoseconds().count();
    }
    ...
    long long Performance::InlinedWithoutLoopsOrRecursion(vector<test> &tests) 
    {
        ...
        sw.Stop();
        cout << "Side effect for InlinedWithoutLoopsOrRecursion(): " << result << endl;
        return sw.GetElapsedNanoseconds().count();
    }
    ...
    void Performance::Compare() 
    {
        ...
        struct result 
        {
            ...
            void show()
            {
                ...
                cout << setw(60) << name << ": " << testCount << " calls in \033[35;1m" << setw(10) << elapsed << "\033[0m nanoseconds." << endl;
            }
        };
